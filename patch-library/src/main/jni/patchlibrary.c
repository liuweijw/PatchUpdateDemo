...
Java_com_github_liuweijw_library_patch_PatchLibrary_make(JNIEnv *env, jclass type, jstring oldFilePath_, jstring newFilePath_,
                             jstring patchPath_) {
...
JNIEXPORT jboolean JNICALL
Java_com_github_liuweijw_library_patch_PatchLibrary_diff(JNIEnv *env, jclass type, jstring oldFilePath_, jstring newFilePath_,
                             jstring patchPath_) {
    char *ch[5] = {0};
    ch[0] = "bsdiff";
    ch[1] = (*env)->GetStringUTFChars(env, oldFilePath_, 0);
